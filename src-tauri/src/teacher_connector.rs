...
pub struct ConnectorState {
    connections: Mutex<HashMap<String, StudentConnection>>,
    command_senders: Mutex<HashMap<String, mpsc::Sender<ConnectionCommand>>>,
}
...
/// Handle a connection to a student
async fn handle_connection(
    ...
    log::info!("[TeacherConnector] Connecting to: {}", url);
