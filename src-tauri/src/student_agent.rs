    ...
    loop {
        tokio::select! {
            ...
            Some(frame_data) = frame_rx.recv() => {
                ...
                let frame_msg = StudentMessage::ScreenFrame {
                ...
                if let Err(e) = send_message(&mut write, &frame_msg).await {
...
fn start_screen_capture(
    ...
    tokio::spawn(async move {
        let settings = CaptureSettings {
            ...
            target_width: 960, // Scale down for transmission
            target_height: 0, // Maintain aspect ratio
        };
        
        println!("[ScreenCapture] Starting capture loop");
